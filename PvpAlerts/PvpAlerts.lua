...
function PVP:OnOff()
	...
	if self.SV.enabled and PVP:IsInPVPZone() then
		if not self.addonEnabled then
			...
			EVENT_MANAGER:RegisterForEvent(self.name, EVENT_GUILD_ID_CHANGED, function() PVP:PopulateGuildmateDatabase() end)
			EVENT_MANAGER:RegisterForEvent(self.name, EVENT_GUILD_SELF_JOINED_GUILD, function() PVP:PopulateGuildmateDatabase() end)
			EVENT_MANAGER:RegisterForEvent(self.name, EVENT_GUILD_SELF_LEFT_GUILD, function() PVP:PopulateGuildmateDatabase() end)
			EVENT_MANAGER:RegisterForEvent(self.name, EVENT_GUILD_MEMBER_ADDED, function() PVP:PopulateGuildmateDatabase() end)
			EVENT_MANAGER:RegisterForEvent(self.name, EVENT_GUILD_MEMBER_REMOVED, function() PVP:PopulateGuildmateDatabase() end)
